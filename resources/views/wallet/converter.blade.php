...
<br><br>
       ...
       @enderror
       <form action="{{route('app_convert_To_Btc') }}"   class="" role="convert"  type="get">
        @csrf
      <center><label for="amount" class="text-light"> <img  src="https://cryptologos.cc/logos/tether-usdt-logo.png" alt="Category image"  style="width: 30px; margin: 0x auto;" >  &#160; To &#160;  <img  src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Bitcoin.svg/1024px-Bitcoin.svg.png" alt="Category image"  style="width: 30px; margin: 0x auto;" > </label></center>
      <br>
      <input type="double" name="convert" id="convert" class="form-control mb-3" >

       <label for="amount" class="text-light">Your total of Bitcoin now is:  {{Auth::user()->btc}} BTC </label>
